...
Before calculations for the final design could take place several assumptions regarding the forces and torques of the hexapod had to be taken into consideration. These can be seen in figures 1 and 2.
...
\begin{figure}
 ...
 \centering
   \includegraphics[width = 0.45\textwidth]{figures/1.png}                \caption{Hexapod diagram with assumptions made}
...
\end{equation}
	...
	The first set of equations focused on the motor inertia as well as the torque value of the model at critical positions along the frame. 
...
\begin{multline} \label{eq: Torque on Upper Arm}
	\Sigma T_h = T_2 - N_1 (L_1 \cos \theta_1 + L_2 \cos \theta_2)\\ +
