...
\subsection{Diagrams}
Before calculations for the final design could take place several assumptions regarding the forces and torques of the hexapod had to be taken into consideration. These can be seen in figures 1 and 2 along with the hexapod diagrams and variables needed for  the final design.
...
Before the models construction,research had first been conducted on various servo motors and their performance as well as subsequent electro mechanical models. Figures 5 and 6 represent the load effects on the system .\\
...
Once the necessary research had been conducted the electromechanical model was designed as can be seen in figure 7.


\begin{figure}[H]
 \centering
   \includegraphics[width = 1.05\textwidth]{figures/7.png}                \caption{Electromechanical Model}
